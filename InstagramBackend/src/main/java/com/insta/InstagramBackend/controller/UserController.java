...
import com.insta.InstagramBackend.service.AuthenticationService;
...
public class UserController {
    ...
    @PostMapping("signup")
    public String signUpInstaUser(@RequestBody @Valid User user)
    {
    ...
    @PostMapping("signIn")
    public String signInInstaUser(@RequestParam String email ,@RequestParam String password)
    {
    ...
    @GetMapping("get_like/count/post/{postId}")
